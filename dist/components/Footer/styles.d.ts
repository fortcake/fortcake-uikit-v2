...
export declare const StyledSocialLinks: import("styled-components").StyledComponent<import("react").NamedExoticComponent<import("../Box").FlexProps & {
    socialLinks: import("./config").socialLinksTypes[];
